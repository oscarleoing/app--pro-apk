    ...
    private fun obtenerSubcategorias(nombreCategoria: String): List<SubCategoriaReporteUI> {
        return when (nombreCategoria) {
            ...
            "Parques y Jardines" -> listOf(
                ...
                SubCategoriaReporteUI("Recolección de ramas", R.drawable.recoleccion_de_ramas_puntero_r, R.color.color_parques_y_jardines_superior, R.color.color_parques_y_jardines_inferior),
